                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <ais-sort-by-selector
                                            :indices="[
										{name: 'alarqam_institutes',label: 'حسب المشاهدة'},
										{name: 'alarqam_institutes_views_asc', label: 'أقل مشاهدة'},
										{name: 'alarqam_institutes_views_desc', label: 'أعلى مشاهدة'}
									  ]"
                                            :classNames="{
                                ...
                                <div class="col-md-3">
                                    <ais-sort-by-selector
                                            :indices="[
												{ name:'alarqam_institutes',label: 'الاكثر اعجاباً'},
												{name: 'alarqam_institutes_likes_asc', label: 'الاقل اعجاباً'},
												{name: 'alarqam_institutes_likes_desc', label: 'الاكثر اعجابا'}
											  ]"
                                            :classNames="{
									'ais-sort-by-selector': 'form-control'
								  }"
