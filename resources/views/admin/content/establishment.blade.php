          ...
          <div class="col-md-12">
               <div class="card">
                    <div class="card-header">
                      <h4 class="card-title" id="horz-layout-basic">اضافة اجتماع مؤسسة</h4>
                      ...
                      <div class="card-body">
                        ...
                        {{ csrf_field()}}
                          <div class="form-body">
                            ...
                            <input type="text" value="مؤسسة" class="form-control" name="meeting_type" hidden>
                            ...
                            <div class="form-group row">
                                    ...
                                    <input value="اجتماع مؤسسة" type="text" name="country" hidden>
