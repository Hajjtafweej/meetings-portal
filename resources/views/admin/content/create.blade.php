          ...
          <div class="col-md-12">
               <div class="card">
                    <div class="card-header">
                      <h4 class="card-title" id="horz-layout-basic">الدول</h4>
                      ...
                      <div class="card-body">
                        ...
                        {{ csrf_field()}}
                          <div class="form-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-1 label-control" for="projectinput1">عن الدولة</label>
                                <div class="col-md-9">
                              ...
                              <hr>
                              <div class="form-group row">
                                  <label class="col-md-1 label-control" for="projectinput1">الوصف الورشة</label>
                                  <div class="col-md-9">
